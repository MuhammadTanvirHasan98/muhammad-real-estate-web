...
const Card = ({ card }) => {
  ...
  return (
    <div className="card rounded-none border-2  border-indigo-400 md:w-full shadow-xl">
      ...
      <div
        data-aos="zoom-in"
        className={`w-full xl:min-h-[380px] lg:min-h-[250px] md:min-h-[300px] min-h-[300px] bg-[url('${image}')] object-cover bg-no-repeat bg-cover bg-center flex flex-col justify-between`}
      >
